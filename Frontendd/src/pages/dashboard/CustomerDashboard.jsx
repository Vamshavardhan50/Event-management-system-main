          ...
          <div className="flex space-x-8 overflow-x-auto no-scrollbar">
            {["Upcoming Tickets", "Past Events", "Browse Events"].map((tab) => (
              <button
                ...
                className={`pb-4 text-sm font-medium transition-colors relative whitespace-nowrap ${activeTab === tab ? "text-orange-500" : "text-muted-foreground hover:text-foreground"}`}
              >
                {tab}
                {activeTab === tab && (
                  <motion.div
                          ...
                          <div className="flex-1 flex flex-col justify-between">
                            <div>
                              <div className="flex justify-between items-start">
                                ...
                                <span
                                  className={`inline-flex items-center text-xs px-2 py-1 rounded-full border ${reg.status === "attended" ? "bg-purple-500/10 text-purple-500 border-purple-500/20" : reg.status === "cancelled" ? "bg-red-500/10 text-red-500 border-red-500/20" : "bg-green-500/10 text-green-500 border-green-500/20"}`}
                                >
                                  {reg.status === "attended"
                                    ? "Attended"
                                    : reg.status === "cancelled"
              ...
              >
                {pastEvents.length === 0 ? (
                  ...
                  >
                    ...
                    <p className="text-muted-foreground mt-2 max-w-sm">
                      Once your events are complete, they will appear here.
                    </p>
                  </motion.div>
                ) : (
                  <div className="grid grid-cols-1 gap-6">
